...
const Planet = ({
  ...
  switch (id) {
    case 1: {
      ...
      rotationspeed = (2 * Math.PI * rotationSpeedFactor) / SECONDS_IN_A_DAY;
      break;
    }
    case 2: {
      // Venus
      ...
      rotationspeed =
        (2 * Math.PI * rotationSpeedFactor) / (5 * SECONDS_IN_A_DAY);
      offset = 2;
      break;
    }
    case 3: {
      ...
      rotationspeed =
        (2 * Math.PI * 0.03 * rotationSpeedFactor) / SECONDS_IN_A_DAY;
      offset = 0;
      break;
    }
    case 4: {
      ...
      rotationspeed =
        (2 * Math.PI * rotationSpeedFactor) / (20 * SECONDS_IN_A_DAY);
      offset = 4;
      break;
    }
    case 5: {
      ...
      rotationspeed =
        (2 * Math.PI * rotationSpeedFactor) / (40 * SECONDS_IN_A_DAY);
      offset = 5;
      break;
    }
    case 6: {
      ...
      rotationspeed =
        (2 * Math.PI * rotationSpeedFactor) / (80 * SECONDS_IN_A_DAY);
      offset = 6;
      break;
    }
    case 7: {
      ...
      rotationspeed =
        (2 * Math.PI * rotationSpeedFactor) / (160 * SECONDS_IN_A_DAY);
      offset = 7;
      break;
    }
    case 8: {
      ...
      rotationspeed =
        (2 * Math.PI * rotationSpeedFactor) / (320 * SECONDS_IN_A_DAY);
      offset = 8;
      break;
    }
    case 9: {
  ...
  return (
    <>
      <group key={`group-${id}`} rotation={[tiltangle, 0, 0]}>
        ...
        {id == 6 && <SaturnRings speed={Ringsspeed} offset={6} />}

        {showMoons &&
          moonsData[id]?.map((moon, index) => (
            <Moon
              key={index}
              index={index}
              id={id}
