    ...
    <div className="planet-info">
      ...
      {currentPage === "info" && (
        <div>
          ...
          <p>{para}</p>
          <p>
            <strong>Length of Year:</strong> {lengthOfYear}
          </p>
          <p>
            <strong>Distance from Sun:</strong> {distanceFromSun}
          </p>
          <p>
            <strong>Number of Moons:</strong> {numberOfMoon}
          </p>
          <p>
            <strong>Relationship to Earth:</strong> {RelationshipToEarth}
          </p>
          <button onClick={() => handlePageChange("video")}>
            Read More: Video
          </button>
