...
const MoonInfo = ({ moonInfo, handleClose }) => {
  const { name, planet, description, discoveryYear, diameter, distanceFromPlanet, interestingFact, videoUrl, mcqs } = moonInfo;
  ...
  return (
    ...
    {currentPage === 'info' && (
      <div>
        ...
        <p><strong>Distance from Planet:</strong> {distanceFromPlanet}</p>
